rule Team_Payload_Detection {
    ...
    strings:
        // 1. El mensaje cifrado (hexadecimal) que tienes en el array encryptedMsg
        ...
        // 3. Patrón de la función VirtualAlloc con permisos PAGE_EXECUTE_READWRITE (0x40)
        // Esto busca la configuración de memoria que pusiste en tu script
        $rwx_allocation = { 00 04 00 00 40 00 00 00 } 

    condition:
        // Verifica que sea un ejecutable (MZ) y que contenga los mensajes o la data cifrada
